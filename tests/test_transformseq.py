...
class Common:
  ...
  def test_add(self):
    self.assertEqual(tuple(self.seq+nutils.transformseq.EmptyTransforms(self.checkfromdim)), tuple(self.check))
...
class EmptyTransforms(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.EmptyTransforms(fromdim=1)
    self.check = ()
...
class PlainTransforms1D(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.PlainTransforms([(x1,s0),(x1,s1),(x1,s2),(x1,s3)], fromdim=1)
...
class PlainTransforms2D(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.PlainTransforms([(x2,s00),(x2,s01),(x2,s10),(x2,s11)], fromdim=2)
...
class MaskedTransforms(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.MaskedTransforms(nutils.transformseq.PlainTransforms([(x2,s00),(x2,s01),(x2,s10),(x2,s11)], fromdim=2), [0,2])
...
class ReorderedTransforms(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.ReorderedTransforms(nutils.transformseq.PlainTransforms([(x2,s00),(x2,s01),(x2,s10),(x2,s11)], fromdim=2), [0,2,3,1])
...
class DerivedTransforms(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.DerivedTransforms(nutils.transformseq.PlainTransforms([(x1,s0),(x1,s1)], fromdim=1), References.uniform(line, 2), 'child_transforms', 1)
...
class UniformDerivedTransforms(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.UniformDerivedTransforms(nutils.transformseq.PlainTransforms([(x1,s0),(x1,s1)], fromdim=1), line, 'child_transforms', 1)
    self.check = (x1,s0,c0),(x1,s0,c1),(x1,s1,c0),(x1,s1,c1)
    self.checkmissing = (l1,s0),(x1,s0),(x1,s1),(r1,s0)
    self.checkrefs = References.uniform(line, 4)
    self.checkfromdim = 1
...
class ChainedTransforms(TestCase, Common, Edges):
  def setUp(self):
    super().setUp()
    self.seq = nutils.transformseq.ChainedTransforms([nutils.transformseq.PlainTransforms([(x1,s0),(x1,s1)], fromdim=1), nutils.transformseq.PlainTransforms([(x1,s2),(x1,s3)], fromdim=1)])
    self.check = (x1,s0),(x1,s1),(x1,s2),(x1,s3)
    self.checkmissing = (l1,s0),(x1,s4),(r1,s0)
    self.checkrefs = References.uniform(line, 4)
    self.checkfromdim = 1
